<x-guest-layout>
        ...
        <div class="flex items-center">
            <div class="slider-cont-fondo w-full">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center">
                    <div class="mt-40">
                        <h1 data-aos="zoom-in" class="text-white text-4xl font-bold -mt-40">Palenque</h1>
                    </div>
                    <div>
    ...
    <section class="overflow-x-hidden" id="concepto">
        <div class="bg-gray-200 pt-10">
            ...
            <p data-aos="zoom-in-right" class="px-5 mb-5 text-base md:text-3xl mt-20 text-center">
                Palenque se ubica en el corazón del sureste de México, al noreste del estado de Chiapas, en una zona de selva tropical alta donde abundan cascadas y ríos. La ubicación perfecta para nuestro nuevo proyecto de Plaza Las Flores.                
            </p>
            <p data-aos="zoom-in-right" class="px-5 mb-5 text-base md:text-3xl mt-20 text-center">
                Plaza Las Flores Palenque es un centro comercial que cuenta con un diseño completamente nuevo en la región, con una línea de acción clara orientada a la nueva sensibilidad de los clientes, mucho más verde, natural, más preocupados por la autenticidad y la sostenibilidad.              </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 p-10 pb-28">
            ...
            <div data-aos="fade-left" class="relative bg-white border-2 border-gray-300 rounded-md shadow-lg p-6 md:top-20 md:-left-20 -left-10 -top-24">
                ...
                <p class="text-base md:text-2xl mt-4 md:px-4">
                    En el interior apostamos al aprovechamiento de las condiciones existentes, eliminando aquellos elementos que obstaculicen el paso de la luz interior, queremos que los espacios fomenten la calidez. 
                </p>
            </div>
        </div>
    ...
    <section class="overflow-x-hidden">
        <div class="relative pb-32 bg-gray-600/10 pt-24 bg-cover bg-center bg-fixed" style="background-image: url(/fondos_prueba/fondo-plqs.jpeg);">
    ...
    <section class="mt-5 overflow-x-hidden">
        <div id="seccion-destino" class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div data-aos="fade-left" class="mt-5 mx-auto my-auto">
                <img src="/plano/2F_LasFlores-Planta Palenque.jpg" width="700px" alt="Imagen del mapa">
            </div>
        </div>
    </section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div data-aos="fade-left" class="md:mr-10">
                <div class="relative overflow-hidden rounded-lg  mt-10">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3804.5383419525206!2d-91.99553422563982!3d17.529537783382004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85f245007fa9d3df%3A0x1e7dc6202c6e2953!2sPlaza%20las%20flores!5e0!3m2!1ses-419!2smx!4v1727549084910!5m2!1ses-419!2smx" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="mx-4 mt-3">
                    <p class="text-sm md:text-lg font-bold mb-4"> <i class="bi bi-geo-alt-fill mr-4 text-xl md:text-2xl"></i>Palenque - Nueva Esperanza, 29960 Palenque, Chis.</p>
