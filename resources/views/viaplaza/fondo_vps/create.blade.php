<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Agregar nuevo fondo Via Plaza') }}
        </h2>
    </x-slot>
    <div class="flex flex-col items-center justify-center mt-10">
        ...
        <form class="px-4 md:px-40 needs-validation w-full max-w-3xl" action="{{route('fondo_vps.store')}}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="mt-4">
