<x-app-layout>
    ...
    <div class="flex flex-col md:flex-row justify-around px-10 mt-5">
        ...
        <a class="bg-green-200 hover:bg-green-400 px-2 py-2 text-center rounded-md font-bold mb-2 md:mb-0" href="{{ route('socios_inicio.create') }}">Agregar nuevo logo</a>
    </div>    
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6">
            ...
            <div class="bg-white shadow-md rounded-lg p-6 flex flex-col h-full">
                ...
                <div class="mt-auto flex justify-around items-center">
                    <div>
                        <a class="bg-blue-200 hover:bg-blue-400 px-4 py-2 rounded-md font-bold" href="{{ route('socios_inicio.edit', $socio->id) }}">Editar</a>
                    </div>
                    <div>
                        <form action="{{ route('socios_inicio.destroy', $socio) }}" method="POST">
                            @csrf
                            @method('DELETE')
