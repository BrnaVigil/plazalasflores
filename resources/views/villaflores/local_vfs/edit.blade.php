<x-app-layout>
    ...
    <div class="flex flex-col items-center justify-center mt-10">
        ...
        <form class="px-4 md:px-40 needs-validation w-full max-w-3xl" action="{{route('local_vfs.update', $local_vf)}}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            @method('PUT')
            <div class="mt-4">
            ...
            <div class="mt-4">
                ...
                <input type="text" id="local" name="local" value="{{$local_vf->local}}" class="w-full py-2 px-4 font-sans file:border-gray-200 border-0 border-gray-200 bg-white rounded-full" placeholder="Numero del local" required>
                <div class="invalid-feedback font-bold">
                    Este campo es requerido                
                </div>
            </div>
            <div class="mt-4">
                ...
                <input type="text" id="nombre" name="nombre" value="{{$local_vf->nombre}}" class="w-full py-2 px-4 font-sans file:border-gray-200 border-0 border-gray-200 bg-white rounded-full" placeholder="Nombre" required>
                <div class="invalid-feedback font-bold">
                    Este campo es requerido                
                </div>
            </div>
            <div class="mx-auto text-center mt-6">
                <a class="bg-blue-200 hover:bg-blue-400 py-2 px-3 rounded-xl" href="{{route('local_vfs.index')}}">ATRÁS</a>
