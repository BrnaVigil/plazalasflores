<x-app-layout>
    ...
    <div class="flex flex-col md:flex-row justify-around px-10 mt-5 mb-2">
        ...
        <a class="bg-green-200 hover:bg-green-400 px-2 py-2 text-center rounded-md font-bold mb-2 md:mb-0" href="{{ route('local_vfs.create') }}">Agregar nuevo local</a>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white shadow-md rounded-lg p-6 flex flex-col">
            ...
            @foreach ($locales as $local_vf)
                @if($local_vf->categoria == 'alimentos')
                    <div class="flex justify-between items-center mb-4 hover:bg-slate-200 hover:px-1 hover:rounded-lg">
                        <div class="flex mb-4 mt-2">
                            <span class="text-gray-600"># local {{$local_vf->local}}</span>
                            <h3 class="text-sm font-bold ml-2 mt-1"> {{$local_vf->nombre}}</h3>
                        </div>
                        <div class="flex justify-end space-x-4">
                            <a class="bg-blue-200 hover:bg-blue-400 px-2 py-1 rounded-md font-bold" href="{{ route('local_vfs.edit', $local_vf) }}">Editar</a>
                            <form action="{{ route('local_vfs.destroy', $local_vf) }}" method="POST">
                                @csrf
                                @method('DELETE')
        ...
        <div class="bg-white shadow-md rounded-lg p-6 flex flex-col h-full">
            ...
            @foreach ($locales as $local_vf)
                @if($local_vf->categoria == 'autoservicio')
        ...
        <div class="bg-white shadow-md rounded-lg p-6 flex flex-col h-full">
            ...
            @foreach ($locales as $local_vf)
                @if($local_vf->categoria == 'autos y motos')
                    <div class="flex justify-between items-center mb-4">
                        <div class="flex mb-4 mt-2">
                            <span class="text-gray-600"># local {{$local_vf->local}}</span>
                            <h3 class="text-sm font-bold ml-2 mt-1"> {{$local_vf->nombre}}</h3>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 flex flex-col h-full">
            ...
            @foreach ($locales as $local_vf)
                @if($local_vf->categoria == 'tecnologia')
                    <div class="flex justify-between items-center mb-4">
                        <div class="flex mb-4 mt-2">
                            <span class="text-gray-600"># local {{$local_vf->local}}</span>
                            <h3 class="text-sm font-bold ml-2 mt-1"> {{$local_vf->nombre}}</h3>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 flex flex-col h-full">
            ...
            @foreach ($locales as $local_vf)
                @if($local_vf->categoria == 'entretenimiento')
                    <div class="flex justify-between items-center mb-4">
                        <div class="flex mb-4 mt-2">
                            <span class="text-gray-600"># local {{$local_vf->local}}</span>
                            <h3 class="text-sm font-bold ml-2 mt-1"> {{$local_vf->nombre}}</h3>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 flex flex-col h-full">
            ...
            @foreach ($locales as $local_vf)
                @if($local_vf->categoria == 'departamental')
                    <div class="flex justify-between items-center mb-4">
                        <div class="flex mb-4 mt-2">
                            <span class="text-gray-600"># local {{$local_vf->local}}</span>
                            <h3 class="text-sm font-bold ml-2 mt-1"> {{$local_vf->nombre}}</h3>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 flex flex-col h-full">
            ...
            @foreach ($locales as $local_vf)
                @if($local_vf->categoria == 'locales disponibles')
                    <div class="flex justify-between items-center mb-4">
                        <div class="flex mb-4 mt-2">
                            <span class="text-gray-600"># local {{$local_vf->local}}</span>
                            <h3 class="text-sm font-bold ml-2 mt-1"> {{$local_vf->nombre}}</h3>
