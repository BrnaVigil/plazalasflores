<x-guest-layout>
        ...
        <div class="flex items-center">
            <div class="slider-cont-fondo w-full">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center">
                    <div class="mt-40">
                        <h1 data-aos="zoom-in" class="text-white text-4xl font-bold -mt-40">Tonala</h1>
                    </div>
                    <div>
                        <h1 data-aos="zoom-in" class="text-3xl md:text-7xl font-bold mb-6 text-gray-50 transition duration-500 p-2 rounded-md text-shadow-lg">
                            Tu Mejor Oportunidad de negocio <br><strong id="changingText-tonala">de tu empresa</strong>
                        </h1>
    ...
    <section class="overflow-x-hidden">
        <div class="grid grid-cols-1 md:grid-cols-2 md:p-24 gap-4 mt-10 mb-10 mx-5">
            ...
            <div data-aos="fade-up-left" class="text-center grid grid-cols-2">
                ...
                <div class="flex flex-col justify-center">
                    <h1 class="text-3xl md:text-6xl font-bold"><strong class="text-green-500">+</strong>230</h1>
            ...
            <div data-aos="fade-up-right" class="text-center grid grid-cols-2">
                ...
                <div class="flex flex-col justify-center">
                    <h1 class="text-3xl md:text-6xl font-bold">7,820<strong class="text-green-500 text-base"> m2</strong></h1>
            ...
            <div data-aos="fade-up-left" class="text-center grid grid-cols-2">
                ...
                <div class="flex flex-col justify-center text-center">
                    <h1 class="text-3xl md:text-6xl font-bold">20<strong class="text-green-500 text-base">mil m2</strong></h1>
    ...
    <section class="overflow-x-hidden" id="concepto">
        <div class="bg-gray-200 pt-20">
            ...
            <p data-aos="zoom-in-right" class="px-5 mb-5 text-base md:text-3xl mt-20 text-center">
                Plaza Las Flores Tonalá es un centro comercial urbano, único desarrollo comercial de su tipo en la región Itsmo-Costa en el estado de Chiapas, el cual atenderá las necesidades de consumo y entretenimiento de los visitantes por medio de tiendas de autoservicio, salas de cine, zona gourmet y una amplia galería comercial.                
            </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 p-10 pb-28">
            ...
            <div data-aos="fade-left" class="relative bg-white border-2 border-gray-300 rounded-md shadow-lg p-6 md:top-20 md:-left-20 -left-10 -top-24">
                ...
                <p class="text-base md:text-2xl mt-4 md:px-4">
                    La zona de influencia de Plaza las Flores Tonalá, abarca una población de alrededor de 202,750 habitantes que incluye a los municipios de Tonalá, Arriaga y Pijijipian Chiapas, asi como los municipios de vecino estado de Oaxaca, San Pedro Tapanatepec, Chahuites y Santo Domingo Zanatepec. Es también el principal abastecedor de pescados, moluscos y mariscos de Chiapas. Además de ser centro de una de las principales regiones ganaderas y poseer una próspera industria turística en desarrollo.                </p>         
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="overflow-x-hidden">
            <div id="seccion-destino" class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div data-aos="fade-left" class="mt-5 mx-auto">
                    <img src="/plano/F_LasFlores-Planta Tonala.jpg" width="600px">
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div data-aos="fade-left" class="md:mr-10">
                <div class="relative overflow-hidden rounded-lg  mt-10">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15333.394397816879!2d-93.770488!3d16.099258!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85949fbdb967702b%3A0xfa38184c37b8c256!2sPlaza%20Las%20Flores%20%5BTonal%C3%A1%5D!5e0!3m2!1ses-419!2sus!4v1725933521572!5m2!1ses-419!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="mx-4 mt-3">
