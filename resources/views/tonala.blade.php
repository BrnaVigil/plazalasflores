<x-guest-layout>
    ...
    <header>
        <nav id="navbar" class="bg-green-pf fixed w-full z-50">
            <div class="container mx-auto flex items-center justify-between ">
                ...
                <div class="logo my-2">
                    <a href="/">
                        <img src="/img/TONALÁ.png" alt="Logo" class="h-20">
                    </a>
                </div>
                ...
                <ul id="menu" class="menu flex md:flex-row md:items-center md:space-x-6 text-white font-normal">
                    ...
                    <li class="hidden md:block"><a href="/tonala" class="block hover:text-gray-300 font-extrabold underline">Tonalá</a></li>
    ...
    <section class="overflow-x-hidden">
        <div class="grid grid-cols-1 md:grid-cols-2 md:p-24 gap-4 mt-10 mb-10 mx-5">
            ...
            <div data-aos="fade-up-right" class="text-center grid grid-cols-2">
                ...
                <div class="flex flex-col justify-center">
                    <h1 class="text-3xl md:text-6xl font-bold"><strong class="text-green-custon">+</strong> 7mil<strong class="text-green-custon text-base"> m2</strong></h1>
            ...
            <div data-aos="fade-up-left" class="text-center grid grid-cols-2">
                ...
                <div class="flex flex-col justify-center text-center">
                    <h1 class="text-3xl md:text-6xl font-bold"><strong class="text-green-custon">+</strong>100<strong class="text-green-custon text-base">mil</strong></h1>
    ...
    <section class="overflow-x-hidden" id="concepto">
        <div class="bg-gray-200 pt-20">
            ...
            <p data-aos="zoom-in-right" class="px-5 mb-5 text-base md:text-3xl mt-20 text-center">
                Plaza Las Flores Tonalá cuenta con un diseño limpio en fachada e interiores, donde buscamos aprovechar toda la luz posible que la zona brinda naturalmente. En este centro comercial apostamos por la energía renovable y logramos establecer un espacio con paneles solares que brindan energía a todas las zonas comunes.
            </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 p-10 pb-28">
            ...
            <div data-aos="fade-left" class="relative bg-white border-2 border-gray-300 rounded-md shadow-lg p-6 md:top-20 md:-left-20 -left-10 -top-24 text-justify">
                ...
                <p class="text-base md:text-2xl mt-4 md:px-4">
                    Nuestro centro comercial cuenta con amplios pasillos llenos de luz, y diseño en fachada con cortes limpios y singulares. Tonalá se encuentra situado en una zona con temperaturas a la sombra de hasta 40 grados centígrados, por ello contamos con equipos de aire acondicionado que brindan confort a nuestros invitados. Sumando a este esfuerzo, este centro comercial cuenta con una mezcla comercial que brinda visitas constantes y prolongadas por parte de los pobladores de la zona que con normalidad se dan cita para realizar sus compras en la variedad de marcas nacionales e internacionales con las que reforzamos los números de afluencia.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="overflow-x-hidden">
        <div class="relative pb-32 bg-gray-600/10 pt-24 bg-cover bg-center bg-fixed" style="background-image: url(/fondos_prueba/fondo-tnla.jpeg);">
    ...
    <section class="overflow-x-hidden">
        <div id="seccion-destino" class="grid grid-cols-1 md:grid-cols-2 px-6">
            ...
            <div id="zoomimage" class="" data-aos="fade-left">
                <img id="zoomimg" src="/plano/F_LasFlores-Planta Tonala.jpg" alt="Imagen para zoom">
            </div>
        </div>        
    </section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div data-aos="fade-left" class="md:mr-10">
                <div class="relative overflow-hidden rounded-lg p-4">
                    <iframe class="w-full h-96" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15333.394397816879!2d-93.770488!3d16.099258!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85949fbdb967702b%3A0xfa38184c37b8c256!2sPlaza%20Las%20Flores%20%5BTonal%C3%A1%5D!5e0!3m2!1ses-419!2sus!4v1725933521572!5m2!1ses-419!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="mx-4 mt-3">
                    <p class="text-sm md:text-lg font-bold mb-4"> <i class="bi bi-geo-alt-fill mr-4 text-xl md:text-2xl"></i>Tonala - Dirección Tonalá |  Prolongación Av. Hidalgo No 312 Col Tramo Tonalá Arriaga, 30500 Tonalá, Chis.</p>
