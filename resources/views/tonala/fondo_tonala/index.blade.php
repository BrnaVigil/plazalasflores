<x-app-layout>
    ...
    <div class="flex flex-col md:flex-row justify-around px-10 mt-5 mb-2">
        ...
        <a class="bg-green-200 hover:bg-green-400 px-2 py-2 text-center rounded-md font-bold mb-2 md:mb-0" href="{{ route('fondo_tonala.create') }}">Agregar nueva imagen de fondo</a>
    </div>
    <h1 class="font-bold mt-5 text-2xl md:text-4xl text-center">IMAGENES DE FONDO TONALA</h1>
            ...
            @foreach ($fondos as $fondo)
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="flex justify-around items-center">
                        <div>
                            <a class="bg-blue-200 hover:bg-blue-400 px-4 py-2 rounded-md font-bold ml-10" href="{{ route('fondo_tonala.edit', $fondo) }}">Editar</a>
                        </div>
                        <div>
                            <form action="{{ route('fondo_tonala.destroy', $fondo) }}" method="POST">
                                @csrf
                                @method('DELETE')
